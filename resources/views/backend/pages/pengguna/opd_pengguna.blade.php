         ...
         <div class="row align-items-center">
             ...
             <div class="col-sm-6">
                <div class="float-end d-none d-sm-block">
                    ...
                    <a href="{{ url('/admin/pengguna-opd-cetak') }}" class="btn btn-warning btn-sm" target="blank_"><i class="fa fa-print"></i></a>
                </div>
             </div>
         </div>
        </div>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="needs-validation" action="{{ url('/admin/penggunaOpdUpdate') }}" method="POST">
                                                            @csrf
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-select" name="opd_id" required>
                                                                            @foreach ($opd as $h)
                                                                                <option @if($h->id==$p->opd_id) selected @endif value="{{ $h->id }}">{{ $h->opd }}</option>
                                                                            @endforeach
                                                                        </select>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form class="needs-validation" action="{{ url('/admin/penggunaOpdDelete') }}" method="POST">
                                                            @csrf
                                                            <input type="hidden" name="id" class="form-control" value="{{ $p->id }}" required>
...
<div class="modal fade add" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation" action="{{ url('/admin/penggunaOpdInsert') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="opd_id" required>
                                    ...
                                    @foreach ($opd as $h)
                                        <option value="{{ $h->id }}">{{ $h->opd }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
                                    Please select a valid data.
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="hak_akses_id" required>
                                    @foreach ($akses as $h)
                                        <option @if($h->id==3) selected @else disabled @endif value="{{ $h->id }}">{{ $h->hak_akses }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
                                    Please select a valid data.
